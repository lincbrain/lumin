...
if __name__ == "__main__":
    ...
    baseimg = "../generative_model_steerable_harmonics/outputs/training_images/"
    baseseg = "../generative_model_steerable_harmonics/outputs/training_labels/"
    baseimagepaths = sorted(
        glob.glob("../generative_model_steerable_harmonics/outputs/gmm_perlin_images/*")
    )
    basesegpaths = sorted(
        glob.glob("../generative_model_steerable_harmonics/outputs/gmm_perlin_labels/*")
    )
