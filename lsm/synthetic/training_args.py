...
def training_args():
    ...
    parser.add_argument("--steps", type=int, default=300, help="iterations per epoch")
    parser.add_argument(
    ...
    parser.add_argument("--name", type=str, help="folder name to store run results")
    parser.add_argument("--lr", type=float, default=2e-4, help="Adam learning rate")
    parser.add_argument(
        "--losswt_1", type=float, default=1, help="centerness cross-entropy loss weight"
    )
    parser.add_argument(
        "--losswt_2",
        type=float,
    ...
    parser.add_argument("--rng_seed", type=int, default=12345, help="NumPy RNG seed")
